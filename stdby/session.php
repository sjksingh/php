...
$username = "system";
$password = "change_me";
$db = "(DESCRIPTION=(ADDRESS_LIST = (ADDRESS = (PROTOCOL = TCP)(HOST = clubrpt.dc.vip.rden.us)(PORT = 1521)))(CONNECT_DATA=(SID = club)))";
...
print '<h3>Connected to Production -Reporting - CLUB</h3>';
